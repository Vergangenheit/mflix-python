...
def get_movies_by_country(countries: List) -> Optional[List]:
    """
    ...
    try:
        ...
        cursor: Cursor = movies.find({'countries': {'$in': countries}}, {"_id": 1, "title": 2})
...
def build_query_sort_project(filters: Dict) -> (Dict, List, Dict):
    """
...
def get_movies(filters: Dict, page: int, movies_per_page: int) -> (List, int):
    """
